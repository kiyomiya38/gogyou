...
ubuntu@ip-172-31-1-87:~/omyou-gogyo-app$ vim diagnose.js
ubuntu@ip-172-31-1-87:~/omyou-gogyo-app$ sudo node index.js
App running on http://localhost:80
^C
ubuntu@ip-172-31-1-87:~/omyou-gogyo-app$ ls
diagnose.js  index.js  node_modules  old  package-lock.json  package.json  public
ubuntu@ip-172-31-1-87:~/omyou-gogyo-app$ cat index.js 
// index.js
const express = require('express');
const app = express();
const port = 80;
